...
import wjx.classmanager.db.DemoDBManager;
import wjx.classmanager.db.InviteMessgeDao;
import wjx.classmanager.db.UserDao;
import wjx.classmanager.model.ClassUser;
import wjx.classmanager.model.DemoModel;
import wjx.classmanager.model.EaseAtMessageHelper;
import wjx.classmanager.model.EaseEmojiconGroupEntity;
import wjx.classmanager.model.EaseNotifier;
import wjx.classmanager.model.EaseUser;
import wjx.classmanager.model.EmojiconExampleGroupData;
import wjx.classmanager.model.InviteMessage;
import wjx.classmanager.model.InviteMessage.InviteMessageStatus;
import wjx.classmanager.model.RobotUser;
import wjx.classmanager.parse.UserProfileManager;
import wjx.classmanager.receiver.CallReceiver;
import wjx.classmanager.ui.activity.MainActivity;
import wjx.classmanager.utils.Constant;
import wjx.classmanager.utils.EaseCommonUtils;
import wjx.classmanager.utils.EaseUI;
import wjx.classmanager.utils.PreferenceManager;
...
//                }
    ...
    class MyGroupChangeListener implements EMGroupChangeListener {
        ...
        public void onRequestToJoinAccepted(String groupId, String groupName, String accepter) {
            //更新用户信息
            SPUtil.huanXinGroupId(appContext,groupId);

            final ClassUser user=  BmobUser.getCurrentUser(ClassUser.class);
            ClassUser classUser=new ClassUser();
            classUser.setGroupId(groupId);
            classUser.setGroupName(groupName);
          classUser.update(user.getObjectId(), new UpdateListener() {
              @Override
              public void done(BmobException e) {
                     if (e==null){
                         Toast.makeText(appContext, "加入班级成功", Toast.LENGTH_SHORT).show();
                     }else {
                         Toast.makeText(appContext, "加入班级失败！", Toast.LENGTH_SHORT).show();
                     }
              }
          });
