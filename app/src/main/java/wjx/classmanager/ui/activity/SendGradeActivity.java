...
public class SendGradeActivity extends BaseActivity {
        ...
        mButtonSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(notifyName)&&!TextUtils.isEmpty(notifyDesc)){
                        ...
                        bmobFile.uploadblock(new UploadFileListener() {
                            ...
                            public void done(BmobException e) {
                                if (e==null){
                                    ...
                                    grade.setClassId(mClassUser.getGroupId());
                                    grade.setTitle(notifyName);
                                    grade.setContent(notifyDesc);
                                    grade.setTime(time);
                                    grade.setFilePath(bmobFile.getUrl());
                                    grade.save(new SaveListener<String>() {
                                        @Override
                                        public void done(String s, BmobException e) {
                                            if (e==null){
                                                sendPd.hide();
                                                Toast.makeText(SendGradeActivity.this, "公布成功..", Toast.LENGTH_SHORT).show();
                                                finish();
                                            }else {
                                                sendPd.hide();
                                                Toast.makeText(SendGradeActivity.this, "公布失败!", Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                    });
                                }   else {
                    ...
                    Toast.makeText(mContext, "成绩标题和成绩描述不能为空！", Toast.LENGTH_SHORT).show();
                }
    ...
    public int getLayout() {
        return R.layout.activity_send_grade;
    }
